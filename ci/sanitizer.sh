...
cargo test -p diarization --lib --target "$TARGET" --no-default-features -- ops:: embed::fbank::tests
...
cargo -Zbuild-std test -p diarization --lib --target "$TARGET" --no-default-features -- ops:: embed::fbank::tests
